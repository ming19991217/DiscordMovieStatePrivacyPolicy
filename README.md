# DiscordMovieStatePrivacyPolicy
...
For the purposes of this Privacy Policy:
  ...
  * Application refers to Discord Movie State, the software program provided
    by the Company.

  * Company (referred to as either "the Company", "We", "Us" or "Our" in this
    Agreement) refers to Discord Movie State.
...
While using Our Service, we collect the following data when you watch movies or shows on streaming platforms:

  * The name of the movie or show you are watching.
  * The specific time point when you watch that movie or show.

Usage Data  
**********

We do not automatically collect any Usage Data that is not related to the movies or shows you watch.
...
The Company may use Personal Data for the following purposes:
  ...
  * To display the name of the movie or show you are watching on Discord.

  * To record a list of movies or shows you've watched for future reference.
...
If you have any questions about this Privacy Policy, You can contact us:
  ...
  * By email: ming19991217@gmail.com
